...
class CritterForm(FlaskForm):
    ...
    price = DecimalField(validators=[DataRequired(), NumberRange(0.01,10**16, "Please select a price between $0.01 and 10,000,000,000,000,000 for your critter")], places=2)
