...
| :------- | :------ | :----------- | :------ |
| GET /api/auth/  | On initial load and subsequent refreshes, returns logged in user if there is one | {<br/>&nbsp;&nbsp;&nbsp;"id": INT, <br/>&nbsp;&nbsp;&nbsp;"username": STRING, <br/>&nbsp;&nbsp;&nbsp;"email": STRING, <br/>&nbsp;&nbsp;&nbsp;"firstName": STRING, <br/>&nbsp;&nbsp;&nbsp;"lastName": STRING, <br/>&nbsp;&nbsp;&nbsp;"balance": DECIMAL<br/>} | 200 |
