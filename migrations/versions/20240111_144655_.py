...
Revision ID: 6008683f3379
Revises: 127134ccfddd
Create Date: 2024-01-11 14:46:55.656429
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['critterId'], ['shops.id'], ),
    sa.ForeignKeyConstraint(['orderId'], ['users.id'], ),
